        ...
        <div className='h-full w-full mt-2 rounded-xl border-2 border-gray-100 p-4'>
          <div className='grid grid-cols-1 gap-2'>
            <div className='flex flex-row gap-2 items-center'>
              ...
              <div>
                <p className="text-sm text-gray-600">Correo Verificado</p>
                <p className="text-base font-medium text-navy-700 dark:text-white">
                  edwinqs55@finsolred.com
                </p>
              </div>
            </div>
            <div className='flex flex-row gap-2 items-center'>
              ...
              <div>
                <p className="text-sm text-gray-600">Correo MSP</p>
                <p className="text-base font-medium text-navy-700 dark:text-white">
                edwinqs55@finsolred.com
                </p>
              </div>
            ...
            <div className='flex flex-row gap-2 items-center'>
              ...
              <div>
                <p className="text-sm text-gray-600">Correo IESS</p>
                <p className="text-base font-medium text-navy-700 dark:text-white">
                edwinqs55@finsolred.com
                </p>
              </div>
